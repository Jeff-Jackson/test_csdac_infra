...
access_entries = {
  ...
  lambda_qa = {
    principal_arn = "arn:aws:iam::012555280953:role/Lambda-CDO-qa-role"
    policy_associations = [{
      policy_arn  = "arn:aws:eks::aws:cluster-access-policy/AmazonEKSClusterAdminPolicy"
      access_scope = { type = "cluster" }
    }]
  ...
  lambda_remove_qa = {
    principal_arn = "arn:aws:iam::012555280953:role/Lambda-CDO-remove-qa-role"
    policy_associations = [{
      policy_arn  = "arn:aws:eks::aws:cluster-access-policy/AmazonEKSClusterAdminPolicy"
      access_scope = { type = "cluster" }
    }]
  ...
  csdac_qa_cluster = {
    principal_arn = "arn:aws:iam::012555280953:role/csdac-qa-cluster-role"
    policy_associations = [{
      policy_arn  = "arn:aws:eks::aws:cluster-access-policy/AmazonEKSClusterAdminPolicy"
      access_scope = { type = "cluster" }
    }]
